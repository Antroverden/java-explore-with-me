...
public class UserCommentController {
    ...
    @PostMapping
    public CommentDto addCommentToEvent(@RequestBody CommentDto commentDto,
    ...
    public CommentDto changeComment(@Valid @RequestBody UpdateCommentRequest updateCommentRequest,
                                    @PathVariable Integer userId,
                                    @PathVariable Integer eventId,
                                    @PathVariable Integer commentId) {
        return commentService.changeComment(userId, eventId, commentId, updateCommentRequest);
    }
